import { GET_BOOKS, GET_BOOKS_ERROR, GET_BOOKS_LOADING, GET_BOOKS_DETAIL, GET_BOOKS_DETAIL_ERROR, ADD_TO_CART, GET_SEARCHED_BOOKS, GET_ALL_BOOKS_IN_CART, GET_ERROR_BOOKS_IN_CART, REMOVE_FROM_CART } from "../action";
...
export const BookDetailReducer = (state = InitialState.bookWithSpecificId, action) => {
    switch (action.type) {
